...
// each function takes in user input and (where applicable) runs it through the
// toUpper function to make the input case-insensitive.
...
// function that takes all input and returns it in upper case letters for
// interpretation by other functions in the MovieManager class
...
// function to return true/false if the program should continue running or
// not, default true.
bool MovieManagerUI::running() { return is_running; };
// function to toggle the private is_running from true and false to start and
// stop the program. mostly to stop when "q" is input.
void MovieManagerUI::togglerun() { is_running = false; };